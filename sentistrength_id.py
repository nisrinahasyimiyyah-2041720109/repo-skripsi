...
class SentiStrength():
    def __init__(self, config=dict()):
        self.negasi = [line.replace('\n','') for line in open("dataset/sentistrength_id/negatingword.txt").read().splitlines()]
        self.tanya = [line.replace('\n','') for line in open("dataset/sentistrength_id/questionword.txt").read().splitlines()]
        #create sentiment words dictionary
        self.sentiwords_txt = [line.replace('\n','').split(":") for line in open("dataset/sentistrength_id/sentiwords_id.txt").read().splitlines()]
...
# def buat_senti(): # Move outside the class
#     config = dict()
...
# def output():
#     # Membaca file CSV hasil preprocessing
#     df = pd.read_csv('dataset/preprocessing/dataset_preprocess.csv')
...
#     def analisis_sentimen(sentence, senti):
#         result = senti.main(sentence)
#         return result

#     # Menggunakan fungsi apply untuk menerapkan analisis sentimen pada setiap baris
#     df['sentimen'] = df[nama_kolom].apply(analisis_sentimen, senti=buat_senti())

#     # Menyimpan perubahan ke dalam file CSV
#     df.to_csv('dataset/sentistrength_id/sentimen_avoskin.csv', index=False)

#     # Membaca file CSV hasil analisis sentimen
#     df = pd.read_csv('dataset/sentistrength_id/sentimen_avoskin.csv')
...
#     # Menyimpan perubahan ke dalam file CSV
#     df.to_csv('dataset/sentistrength_id/sentimen_avoskin_terpisah.csv', index=False)
