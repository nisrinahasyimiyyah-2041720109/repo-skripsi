...
class TextPreprocessingSomethinc():
    ...
    def remove_stopwords(self, text):
        ...
        return [word for word in text if word not in stopwordTexts]
    ...
    def output(self, export):
        ...
        if export == True:
            ...
            self.dataframe.to_csv('dataset/preprocessing/dataset_preprocess_somethinc.csv', index=False)
