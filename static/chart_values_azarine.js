$(document).ready( () => {
    ...
    $('#btn_upload_dataset_azarine').on('click', () => {
        if($('#form_upload_dataset_azarine')[0].files.length === 0){
            Swal.fire({
            ...
            form_data = new FormData($('#upload_file_dataset_azarine')[0]);
            $.ajax({
                url: '/api/file/dataset/azarine',
                type: 'POST',
                data: form_data,
                contentType: false,
                cache: false,
    ...
    $('#btn_preprocess_azarine').on('click', () => {
        $.ajax({
            url: '/api/preprocess/azarine',
            type: 'POST',
            contentType: false,
            cache: false,
            processData: false,
    ...
    $('#btn_sentistrength_azarine').on('click', () => {
        $.ajax({
            url: '/api/sentistrength/azarine',
            type: 'POST',
            contentType: false,
            cache: false,
            processData: false,
