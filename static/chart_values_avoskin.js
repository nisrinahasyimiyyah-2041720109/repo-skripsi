$(document).ready( () => {
    ...
    $('#btn_upload_dataset_avoskin').on('click', () => {
        if($('#form_upload_dataset_avoskin')[0].files.length === 0){
            Swal.fire({
            ...
            form_data = new FormData($('#upload_file_dataset_avoskin')[0]);
            $.ajax({
                url: '/api/file/dataset/avoskin',
                type: 'POST',
                data: form_data,
                contentType: false,
                cache: false,
    ...
    $('#btn_preprocess_avoskin').on('click', () => {
        $.ajax({
            url: '/api/preprocess/avoskin',
            type: 'POST',
            contentType: false,
            cache: false,
            processData: false,
    ...
    $('#btn_sentistrength_avoskin').on('click', () => {
        $.ajax({
            url: '/api/sentistrength/avoskin',
            type: 'POST',
            contentType: false,
            cache: false,
            processData: false,
