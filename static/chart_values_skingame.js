$(document).ready( () => {
    ...
    $('#btn_upload_dataset_skingame').on('click', () => {
        if($('#form_upload_dataset_skingame')[0].files.length === 0){
            Swal.fire({
            ...
            form_data = new FormData($('#upload_file_dataset_skingame')[0]);
            $.ajax({
                url: '/api/file/dataset/skingame',
                type: 'POST',
                data: form_data,
                contentType: false,
                cache: false,
    ...
    $('#btn_preprocess_skingame').on('click', () => {
        $.ajax({
            url: '/api/preprocess/skingame',
            type: 'POST',
            contentType: false,
            cache: false,
            processData: false,
    ...
    $('#btn_sentistrength_skingame').on('click', () => {
        $.ajax({
            url: '/api/sentistrength/skingame',
            type: 'POST',
            contentType: false,
            cache: false,
            processData: false,
